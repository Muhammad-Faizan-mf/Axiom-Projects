...
//DOM elements for hangman parts
...
//Array to store incorrect letters
const incorrectLetters = [];

//Displaying words in UI
function renderWord(){
...
window.addEventListener('keydown', e=>{
    //checking that the press key is alphabet
